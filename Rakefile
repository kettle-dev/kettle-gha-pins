...
# kettle-gha-pins Rakefile v7.1.0 - 2026-07-22
...
# rake install                                # Build and install kettle-gha-pins-1.0.0.gem in...
# rake install:local                          # Build and install kettle-gha-pins-1.0.0.gem in...
# rake kettle:jem:install                     # Internal target used by `kettle-jem install`
# rake kettle:jem:selftest                    # Self-test: template kettle-gha-pins against itse...
