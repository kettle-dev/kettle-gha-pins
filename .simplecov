# kettle-jem:freeze
# To retain chunks of comments & code during kettle-gha-pins templating:
# Wrap custom sections with freeze markers (e.g., as above and below this comment chunk).
# kettle-gha-pins will then preserve content between those markers across template runs.
# kettle-jem:unfreeze
