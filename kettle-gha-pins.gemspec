...
Gem::Specification.new do |spec|
  ...
  spec.metadata["homepage_uri"] = "https://github.com/kettle-dev/kettle-gha-pins"
  ...
  spec.add_development_dependency("kettle-dev", "~> 2.5", ">= 2.5.14")             # ruby >= 2.4.0
  ...
  spec.add_development_dependency("kettle-test", "~> 2.0", ">= 2.0.17")            # ruby >= 2.4.0
