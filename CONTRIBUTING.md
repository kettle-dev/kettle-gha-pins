...
in `.structuredmerge/kettle-jem.yml`; this project was templated with `ruby.test_minimum: 2.4.0`.
...
- One spec file per class/module. For each class or module under `lib/`, keep all of its unit tests in a single spec file under `spec/` that mirrors the path and file name exactly: `lib/kettle/gha/pins/my_class.rb` -> `spec/kettle/gha/pins/my_class_spec.rb`.
...
[🧪build]: https://github.com/kettle-dev/kettle-gha-pins/actions
